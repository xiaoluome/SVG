...
JNIEXPORT jlong JNICALL Java_me_xiaoluo_svg_SvgRaster_svgAndroidCreate
(JNIEnv * env, jclass jc)
{	
	return (jlong)svgAndroidCreate();
}

JNIEXPORT jint JNICALL Java_me_xiaoluo_svg_SvgRaster_svgAndroidDestroy
...
JNIEXPORT jint JNICALL Java_me_xiaoluo_svg_SvgRaster_svgAndroidParseBuffer
...
JNIEXPORT jint JNICALL Java_me_xiaoluo_svg_SvgRaster_svgAndroidParseChunkBegin
(JNIEnv *env, jclass jc, jlong _svg_android_r)
{
	svg_android_t *svg_android = (svg_android_t *)_svg_android_r;
...
JNIEXPORT jint JNICALL Java_me_xiaoluo_svg_SvgRaster_svgAndroidParseChunk
(JNIEnv *env, jclass jc, jlong _svg_android_r, jstring _bfr)
{
	svg_android_t *svg_android = (svg_android_t *)_svg_android_r;
...
JNIEXPORT jint JNICALL Java_me_xiaoluo_svg_SvgRaster_svgAndroidParseChunkEnd
(JNIEnv *env, jclass jc, jlong _svg_android_r)
{
	svg_android_t *svg_android = (svg_android_t *)_svg_android_r;
...
void __prepare_android_interface(svg_android_t *svg_android, JNIEnv *env, jobject *android_canvas) {
	...
	// prepare raster
	if(!raster_clazz) {
		d = (*env)->FindClass(env, "me/xiaoluo/svg/SvgRaster");
...
JNIEXPORT int JNICALL Java_me_xiaoluo_svg_SvgRaster_svgAndroidSetAntialiasing
...
JNIEXPORT jint JNICALL Java_me_xiaoluo_svg_SvgRaster_svgAndroidRender
...
JNIEXPORT jint JNICALL Java_me_xiaoluo_svg_SvgRaster_svgAndroidRenderToArea
(JNIEnv *env, jclass jc, jlong _svg_android_r, jobject android_canvas,
...
JNIEXPORT void JNICALL Java_me_xiaoluo_svg_SvgRaster_svgAndroidSetBoundingBox
